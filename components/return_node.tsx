...
const ReturnNode: NextPage = () => {
  return (
    <section className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-[3px] box-border max-w-full text-right text-base-2 text-ea-white font-jost">
      <div className="flex-1 flex flex-col items-start justify-start pt-[34px] pb-[57.09999999999991px] pr-[195px] pl-[166.30000000000018px] box-border gap-[50.6px] bg-[url('/bg@2x.png')] bg-cover bg-no-repeat bg-[top] max-w-full z-[1] mq850:gap-[25px] mq850:pt-5 mq850:pb-6 mq850:pr-12 mq850:pl-[41px] mq850:box-border mq1225:pt-[22px] mq1225:pb-[37px] mq1225:pr-[97px] mq1225:pl-[83px] mq1225:box-border">
        <img
        ...
        <img
          ...
          src="/vector.svg"
        />
        <div className="w-[296.8px] flex flex-row items-start justify-start py-0 pr-0.5 pl-[1.699999999999818px] box-border">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[66.7px] max-w-full text-left text-lg-5 text-whitesmoke-200 mq450:gap-[17px] mq850:gap-[33px]">
          <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0.5 pl-[1.699999999999818px] box-border max-w-full">
            <div className="flex-1 flex flex-row items-start justify-start gap-[156.9px] max-w-full mq450:gap-[20px] mq850:gap-[39px] mq1225:gap-[78px]">
              <div className="flex flex-col items-start justify-start gap-[31.9px] mq1225:hidden">
                <div className="w-[160.5px] flex flex-col items-start justify-start pt-0 px-0 pb-[7.700000000000273px] box-border gap-[13.8px] text-base-2">
                  <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[4.699999999999818px] gap-[4.6px] text-xl-8 text-white">
              ...
              <div className="flex-1 flex flex-row items-start justify-start gap-[90.2px] max-w-[calc(100%_-_395px)] text-base-2 mq850:gap-[23px] mq1225:gap-[45px] mq1225:max-w-full">
                <div className="flex flex-col items-start justify-start gap-[4.6px] mq850:hidden">
                  <div className="w-[133px] h-[30px] relative text-xl-8 font-medium text-white inline-block z-[1] mq450:text-mid">
                    Audit Services
                  </div>
                  <div className="w-[132.8px] flex flex-row items-start justify-start pt-0 px-0 pb-[13.900000000000093px] box-border">
                  ...
                  <div className="flex flex-row items-start justify-start pt-0 px-0 pb-[9.200000000000273px]">
                ...
                <div className="flex-1 flex flex-row items-start justify-start gap-[18.5px] max-w-[calc(100%_-_272px)] text-xl-8 text-white mq850:max-w-full">
                  <div className="flex-1 flex flex-col items-start justify-start gap-[86.8px] max-w-[calc(100%_-_226px)] mq450:gap-[22px] mq850:gap-[43px] mq850:max-w-full">
                    <div className="w-[629.1px] flex flex-row items-start justify-start py-0 pr-[67px] pl-[66.30000000000018px] box-border max-w-full mq850:pl-[33px] mq850:pr-[33px] mq850:box-border">
                      <div className="flex-1 flex flex-col items-start justify-start gap-[18.5px] max-w-full">
                        <div className="w-[437.8px] flex flex-col items-start justify-start gap-[4.6px] max-w-full">
                          <div className="self-stretch flex flex-row items-start justify-between gap-[20px] mq450:flex-wrap">
                            <div className="h-[30px] w-[145px] relative font-medium inline-block z-[1] mq450:text-mid">
                              Quill Ecosystem
                            </div>
                            <div className="h-[30px] w-[136px] relative font-medium inline-block z-[1] mq450:text-mid">
                              Other Services
                            </div>
                          </div>
                          <div className="self-stretch flex flex-row flex-wrap items-start justify-between gap-[20px]">
                            <div className="h-[2.3px] w-[145.5px] relative rounded-[18.48px] bg-dodgerblue z-[1]" />
                            <div className="h-[2.3px] w-[136.3px] relative rounded-[18.48px] bg-dodgerblue z-[1]" />
                          </div>
                        </div>
                        <div className="self-stretch flex flex-row items-start justify-between gap-[20px] text-base-2 text-whitesmoke-200 mq850:flex-wrap">
                          <div className="flex flex-col items-start justify-start gap-[13.87px]">
                          ...
                          <div className="flex flex-col items-start justify-start gap-[13.87px] ml-[20px]">
                    ...
                    <div className="self-stretch flex flex-col items-start justify-start gap-[18.5px]">
                      ...
                      <div className="self-stretch flex flex-row items-start justify-start gap-[18.55px] mq850:flex-wrap">
                        <button className="cursor-pointer [border:none] pt-[9.199999999999818px] px-[40.40000000000009px] pb-[9.400000000000093px] bg-[transparent] flex-[0.8253] rounded-[4.62px] [background:linear-gradient(267.25deg,_#7184fd_20%,_#3f7af0_50%,_#4f37ee)] shadow-[0px_11.5px_17.32px_-3.47px_rgba(0,_0,_0,_0.1),_0px_4.6px_6.93px_-4.62px_rgba(0,_0,_0,_0.1)] overflow-hidden flex flex-row items-start justify-start box-border min-w-[154px] z-[1] mq450:flex-1">
                          <div className="h-[23px] flex-1 relative text-base-2 font-medium font-jost text-white text-center inline-block">
                            Refer-Earn-Secure
                          </div>
                        </button>
                        <button className="cursor-pointer [border:none] pt-[9.199999999999818px] pb-[9.400000000000093px] pr-[52px] pl-[51px] bg-[transparent] flex-[0.6812] rounded-[4.62px] [background:linear-gradient(267.25deg,_#7184fd_20%,_#3f7af0_50%,_#4f37ee)] shadow-[0px_11.5px_17.32px_-3.47px_rgba(0,_0,_0,_0.1),_0px_4.6px_6.93px_-4.62px_rgba(0,_0,_0,_0.1)] overflow-hidden flex flex-row items-start justify-start box-border min-w-[154px] whitespace-nowrap z-[1] mq450:flex-1">
                        ...
                        <button className="cursor-pointer [border:none] pt-[9.199999999999818px] pb-[9.400000000000093px] pr-[26.199999999999932px] pl-[27.700000000000045px] bg-[transparent] flex-1 rounded-[4.62px] [background:linear-gradient(267.25deg,_#7184fd_20%,_#3f7af0_50%,_#4f37ee)] shadow-[0px_11.5px_17.32px_-3.47px_rgba(0,_0,_0,_0.1),_0px_4.6px_6.93px_-4.62px_rgba(0,_0,_0,_0.1)] overflow-hidden flex flex-row items-start justify-start box-border min-w-[154px] whitespace-nowrap z-[1]">
                          <div className="h-[23px] flex-1 relative text-base-2 font-medium font-jost text-white text-center inline-block">
                            Ambassador Program
                          </div>
                        </button>
                  ...
                  <div className="w-[207.9px] flex flex-col items-start justify-start gap-[142.4px] text-base-2 text-whitesmoke-200 mq850:hidden">
                    <div className="flex flex-row items-start justify-start py-0 pr-10 pl-[39.700000000000045px]">
                      <div className="flex flex-col items-start justify-start gap-[4.6px]">
                        ...
                        <div className="w-[107.4px] flex flex-row items-start justify-start pt-0 px-0 pb-[13.900000000000093px] box-border">
                          <div className="h-[2.3px] flex-1 relative rounded-[18.48px] bg-dodgerblue z-[1]" />
                        </div>
                        <div className="flex flex-row items-start justify-start pt-0 px-0 pb-[9.300000000000182px]">
                    ...
                    <button className="cursor-pointer [border:none] pt-[9.199999999999818px] pb-[9.400000000000093px] pr-[30.699999999999932px] pl-[31.200000000000045px] bg-[transparent] self-stretch rounded-[4.62px] [background:linear-gradient(267.25deg,_#7184fd_20%,_#3f7af0_50%,_#4f37ee)] shadow-[0px_11.5px_17.32px_-3.47px_rgba(0,_0,_0,_0.1),_0px_4.6px_6.93px_-4.62px_rgba(0,_0,_0,_0.1)] overflow-hidden flex flex-row items-start justify-start whitespace-nowrap z-[1]">
                      <div className="h-[23px] flex-1 relative text-base-2 font-medium font-jost text-white text-center inline-block">
                        Partnership Program
                      </div>
                    </button>
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[39.9px] max-w-full text-sm-9 text-white mq850:gap-[20px]">
            <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-[1.699999999999818px] box-border max-w-full">
